...
## 🛠️ What operations did I perform?
...
- `pandas_basics.ipynb`: The Jupyter Notebook containing all the Python code and step-by-step notes.
- `dataset.csv`: The raw data file used to test and run the code.
